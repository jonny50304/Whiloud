...
public class CreateWEB {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException, SerialException, SQLException {
		...
		rb.add(rb21);rb.add(rb22);rb.add(rb23);rb.add(rb24);rb.add(rb25);rb.add(rb26);rb.add(rb27);rb.add(rb28);rb.add(rb29);rb.add(rb30);
		...
		rb.add(rb51);rb.add(rb52);rb.add(rb53);rb.add(rb54);rb.add(rb55);rb.add(rb56);rb.add(rb57);rb.add(rb58);rb.add(rb59);rb.add(rb60);
		rb.add(rb61);rb.add(rb62);rb.add(rb63);rb.add(rb64);rb.add(rb65);
